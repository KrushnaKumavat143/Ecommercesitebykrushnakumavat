                        ...
                        <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                            <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                                <li class="tab-element active">
                                    <a href="#tab01_1st" class="tab-link"><span class=""></span><?php echo $array_collum['0']; ?></a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_2nd" class="tab-link"><span class=""></span></span><?php echo $array_collum['1']; ?></a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_3rd" class="tab-link"><span class=""></span></span><?php echo $array_collum['2']; ?></a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_4th" class="tab-link"><span class=""></span></span><?php echo $array_collum['3']; ?></a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_5th" class="tab-link"><span class=""></span></span><?php echo $array_collum['4']; ?></a>
                                </li>
                            </ul>
                        </div>
